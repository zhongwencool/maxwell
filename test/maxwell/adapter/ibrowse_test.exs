  ...
  test "sync request" do
    ...
    |> stub(:send_req, fn _, _, _, _, _ ->
      {:ok, '200',
       [
         {'Server', 'nginx'},
         {'Date', 'Sun, 18 Dec 2016 03:02:14 GMT'},
  ...
  test "encode decode json test" do
    ...
    |> stub(:send_req, fn _, _, _, _, _ ->
      {:ok, '200',
       [
         {'Server', 'nginx'},
         {'Date', 'Sun, 18 Dec 2016 03:12:20 GMT'},
         {'Content-Type', 'application/json'},
         {'Content-Length', '383'},
         {'Connection', 'keep-alive'},
         {'Access-Control-Allow-Origin', '*'},
  ...
  test "send file without content-type" do
    ...
    |> stub(:send_req, fn _, _, _, _, _ ->
      {:ok, '200',
       [
         {'Server', 'nginx'},
         {'Date', 'Sun, 18 Dec 2016 03:16:37 GMT'},
         {'Content-Type', 'application/json'},
         {'Content-Length', '316'},
         {'Connection', 'keep-alive'},
         {'Access-Control-Allow-Origin', '*'},
  ...
  test "send file with content-type" do
    ...
    |> stub(:send_req, fn _, _, _, _, _ ->
      {:ok, '200',
       [
         {'Server', 'nginx'},
         {'Date', 'Sun, 18 Dec 2016 03:17:51 GMT'},
         {'Content-Type', 'application/json'},
         {'Content-Length', '316'},
         {'Connection', 'keep-alive'},
         {'Access-Control-Allow-Origin', '*'},
  ...
  test "send stream" do
    ...
    |> stub(:send_req, fn _, _, _, _, _ ->
      {:ok, '200',
       [
         {'Server', 'nginx'},
         {'Date', 'Sun, 18 Dec 2016 03:21:15 GMT'},
         {'Content-Type', 'application/json'},
         {'Content-Length', '283'},
         {'Connection', 'keep-alive'},
         {'Access-Control-Allow-Origin', '*'},
  ...
  test "user-agent header test" do
    ...
    |> stub(:send_req, fn _, _, _, _, _ ->
      {:ok, '200',
       [
         {'Server', 'nginx'},
         {'Date', 'Sun, 18 Dec 2016 03:21:57 GMT'},
         {'Content-Type', 'application/json'},
         {'Content-Length', '27'},
         {'Connection', 'keep-alive'},
         {'Access-Control-Allow-Origin', '*'},
  ...
  test "/put" do
    ...
    |> stub(:send_req, fn _, _, _, _, _ ->
      {:ok, '200',
       [
         {'Server', 'nginx'},
         {'Date', 'Sun, 18 Dec 2016 03:23:00 GMT'},
         {'Content-Type', 'application/json'},
         {'Content-Length', '303'},
         {'Connection', 'keep-alive'},
         {'Access-Control-Allow-Origin', '*'},
  ...
  test "/delete" do
    ...
    |> stub(:send_req, fn _, _, _, _, _ ->
      {:ok, '200',
       [
         {'Server', 'nginx'},
         {'Date', 'Sun, 18 Dec 2016 03:24:08 GMT'},
         {'Content-Type', 'application/json'},
         {'Content-Length', '225'},
         {'Connection', 'keep-alive'},
         {'Access-Control-Allow-Origin', '*'},
