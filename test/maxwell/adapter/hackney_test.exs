  ...
  test "sync request" do
    ...
    |> stub(:request, fn _, _, _, _, _ ->
      {:ok, 200,
       [
         {"Server", "nginx"},
         {"Date", "Sun, 18 Dec 2016 03:33:54 GMT"},
  ...
  test "encode decode json" do
    ...
    |> stub(:request, fn _, _, _, _, _ ->
      {:ok, 200,
       [
         {"Server", "nginx"},
         {"Date", "Sun, 18 Dec 2016 03:40:41 GMT"},
         {"Content-Type", "application/json"},
         {"Content-Length", "419"},
         {"Connection", "keep-alive"},
         {"Access-Control-Allow-Origin", "*"},
  ...
  test "send file" do
    ...
    |> stub(:request, fn _, _, _, _, _ ->
      {:ok, 200,
       [
         {"Server", "nginx"},
         {"Date", "Sun, 18 Dec 2016 03:46:14 GMT"},
         {"Content-Type", "application/json"},
         {"Content-Length", "352"},
         {"Connection", "keep-alive"},
         {"Access-Control-Allow-Origin", "*"},
  ...
  test "send stream" do
    ...
    |> stub(:start_response, fn _ ->
      {:ok, 200,
       [
         {"Server", "nginx"},
         {"Date", "Sun, 18 Dec 2016 03:47:26 GMT"},
         {"Content-Type", "application/json"},
         {"Content-Length", "267"},
         {"Connection", "keep-alive"},
         {"Access-Control-Allow-Origin", "*"},
  ...
  test "user-agent header test" do
    ...
    |> stub(:request, fn _, _, _, _, _ ->
      {:ok, 200,
       [
         {"Server", "nginx"},
         {"Date", "Sun, 18 Dec 2016 03:52:41 GMT"},
         {"Content-Type", "application/json"},
         {"Content-Length", "27"},
         {"Connection", "keep-alive"},
         {"Access-Control-Allow-Origin", "*"},
  ...
  test "/put" do
    ...
    |> stub(:request, fn _, _, _, _, _ ->
      {:ok, 200,
       [
         {"Server", "nginx"},
         {"Date", "Sun, 18 Dec 2016 03:54:56 GMT"},
         {"Content-Type", "application/json"},
         {"Content-Length", "339"},
         {"Connection", "keep-alive"},
         {"Access-Control-Allow-Origin", "*"},
  ...
  test "/delete" do
    ...
    |> stub(:request, fn _, _, _, _, _ ->
      {:ok, 200,
       [
         {"Server", "nginx"},
         {"Date", "Sun, 18 Dec 2016 03:53:52 GMT"},
         {"Content-Type", "application/json"},
         {"Content-Length", "233"},
         {"Connection", "keep-alive"},
         {"Access-Control-Allow-Origin", "*"},
  ...
  test "Head without body(test hackney.ex return {:ok, status, header})" do
    ...
    |> stub(:request, fn _, _, _, _, _ ->
      {:ok, 200,
       [
         {"Server", "nginx"},
         {"Date", "Sun, 18 Dec 2016 03:57:09 GMT"},
