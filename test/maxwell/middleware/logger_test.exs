defmodule LoggerTest do
  ...
  test "Logger Call" do
    ...
    outputok  = capture_log fn -> Maxwell.Middleware.Logger.call(conn, fn(x) ->
                                                                          :timer.sleep(1)
                                                                          x end, [default: :info]) end
