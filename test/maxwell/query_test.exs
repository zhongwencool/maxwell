# The following module test was copied from Plug:
...
defmodule Maxwell.QueryTest do
  ...
  import Maxwell.Query, only: [decode: 1, encode: 1, encode: 2]
  doctest Maxwell.Query
  ...
  defp decode_pair(pairs) do
    Enum.reduce Enum.reverse(pairs), %{}, &Maxwell.Query.decode_pair(&1, &2)
  end
  ...
  test "raise exception on bad www-form" do
